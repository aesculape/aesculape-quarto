---
title: Aesculape Template
format:
  aesculape-quarto-revealjs: 
    footer: Aesculape Template
author: DrJohan
date: today
...
If you noticed [above]{.yellow}, there was some NA or missing data. We can remove those rows for now.
